...
if __name__=="__main__":
	...
	# ved tid t.
		...
		#HER MAA DU SKRIVE EN LIJE SOM TILORDNER a-verdier
	a = u * beta / (m0 + beta * t) - g

	# Regne ut hastigheten v(t)=-u*ln(m0/(m0+beta*t))-g*t
	# ved tid t.

		#HER MAA DU SKRIVE EN LIJE SOM TILORDNER v-verdier
