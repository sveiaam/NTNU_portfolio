...
a1 = rd.read_csv('Tabell 2.3 Buyco Davis.csv')     #Leser inn data som np.array
...
plt.plot(a1[:,0], a1[:,1]*113.1, marker='o', ls='', lw=3, label='Eksperimentelle data') #mult for SI
...
plt.ylabel(r'$\textit{C}$ / $J$ $\cdot$ $mol^{-1}$ $\cdot$ $K^{-1}$', fontsize=18)
plt.grid()
plt.legend(loc='upper left')
plt.title('Plott 3', size=18)
plt.show()
