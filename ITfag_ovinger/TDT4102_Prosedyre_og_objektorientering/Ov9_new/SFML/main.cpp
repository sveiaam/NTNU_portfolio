        ...
        while (window.pollEvent(event)) {
            ...
            case sf::Event::MouseButtonPressed:
                if (event.mouseButton.button == sf::Mouse::Left && !game->isGameOver()) {
					...
					// Lagt til :: sjekker om det er flere lukkede tiles igjen enn miner
					if (game->numTilesRemaining() == game->getBombs()) {
						cout << "SPILLET ER VUNNET! Trykk ESC eller Q for å avslutte, eller MELLOMROM for å starte på nytt" << endl;
					}
                }
